...
import { FiArrowRight, FiCheck, FiSearch, FiTrendingUp, FiBarChart } from 'react-icons/fi'
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-white/70 mt-6">
                We improve your website ranking on Google through keyword research, 
                content optimization, technical SEO and backlink strategies.
              </p>
            ...
            >
              <div className="glass-card rounded-3xl p-12 aspect-square flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold">Rank #1 on Google</h3>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-white/60 mb-8">
              Want to rank higher on Google? Contact us now!
            </p>
