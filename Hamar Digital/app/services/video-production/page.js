...
import { FiArrowRight, FiCheck, FiVideo, FiEdit3, FiPlay } from 'react-icons/fi'
...
export default function VideoProductionPage() {
  ...
  const services = [
    ...
    },
    {
      icon: <FiEdit3 />,
      title: 'Video Editing',
      description: 'Expert editing with color grading and visual effects.',
    },
    {
      icon: <FiPlay />,
      title: 'Reels Creation',
      description: 'Trendy reels optimized for social media engagement.',
    },
  ]
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-white/70 mt-6">
                We create high-quality promotional videos, reels and brand storytelling 
                content that captures attention and converts viewers into customers.
              </p>
            ...
            >
              <div className="glass-card rounded-3xl p-12 aspect-square flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold">Professional Videos</h3>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-white/60 mb-8">
              Need professional video content? Contact us now!
            </p>
